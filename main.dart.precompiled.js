...
fX:[function(a,b,c,d){this.XA.B7(d)},"$4","gOf",8,0,37],
...
I.$lazy($,"_instance","cf","rg",function(){var z=new S.ns(null,null,P.NZ(null,P.EH),null,null,0)
z.zw()
return z})
...
if($desc instanceof Array)$desc=$desc[1]
O8.prototype=$desc
function ns(ou,Xw,XA,tw,Uh,CX){this.ou=ou
this.Xw=Xw
this.XA=XA
this.tw=tw
this.Uh=Uh
